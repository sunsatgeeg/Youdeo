			...
			<div class="single-channel-image">
				...
				<div class="single-channel-nav">
					<nav class="navbar navbar-expand-lg navbar-light">
						<a class="channel-brand " href="#">${user.u_name} <span class="verified" title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified" id="${user.u_verified}"><i class="fas fa-check-circle text-success"></i></span>
							<div>
								<small>구독자 : ${sub.s_count}명</small>
							</div>
						</a>
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<form class="form-inline my-2 my-lg-0">
								...
								&nbsp;&nbsp;&nbsp;
								<button class="btn btn-sm Subscribebtn" type="button" id="${user.u_id}">Subscribe</button>
							</form>
						</div>
					</nav>
				</div>
