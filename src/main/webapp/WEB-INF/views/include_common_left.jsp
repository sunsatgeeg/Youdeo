...
<ul class="sidebar navbar-nav">
	...
	<c:choose>
		<c:when test="${!empty(sUserId)}">
			<li class="nav-item"><a class="nav-link" href="subscriptions"> <i class="fas fa-fw fa-users"></i> <span><s:message code="subscribe" /></span>
			</a></li>
			...
			<li class="nav-item channel-sidebar-list">
				...
				<c:forEach items="${navSubList}" var="sub">
					<ul>
						<li><a href="user?u_id=${sub.s_id}"> <img class="channel-profile-img" alt="" src="img/user/${sub.user.u_profileimg}"> ${sub.user.u_name }
						</a></li>
					</ul>
				</c:forEach>
			</li>
