					...
					<div class="login-main-left">
						...
						<form name="f">
							<div class="form-group">
								<label>Id</label> <input type="text" name="u_id" id="u_id" class="form-control" value="${fuser.u_id}">
							</div>
							<div class="form-group">
								<label>Password</label> <input type="password" name="u_password" id="u_password" class="form-control" value="${fuser.u_password}">
							</div>
							<div class="mt-4">
								<div class="row">
									<div class="col-12">
										<button type="button" class="btn btn-outline-primary btn-block btn-lg submit">Sign In</button>
									</div>
								</div>
							</div>
						</form>
