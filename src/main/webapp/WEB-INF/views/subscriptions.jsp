							...
							<div class="channels-card">
								<div class="channels-card-image">
									...
									<div class="channels-card-image-btn">
										<button type="button" class="btn btn-success btn-sm border-none">
						...
						<div class="col-xl-3 col-sm-6 mb-3">
							<div class="channels-card">
								<div class="channels-card-image">
									...
									<div class="channels-card-image-btn">
										<button type="button" class="btn btn-danger btn-sm border-none">
											Subscribe <strong>1.4M</strong>
										</button>
										<button type="button" class="btn btn-warning btn-sm border-none">
											<i class="fas fa-times-circle"></i>
						...
						<div class="col-xl-3 col-sm-6 mb-3">
							<div class="channels-card">
								<div class="channels-card-image">
									...
									<div class="channels-card-image-btn">
										<button type="button" class="btn btn-secondary btn-sm border-none">
